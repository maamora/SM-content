...
function DashboardPageInner() {
  ...
  useEffect(() => {
    ...
    // This is a shared workspace — another teammate can add/approve/generate
    // from their own session at any time. Without this, a tab left open just
    // shows stale numbers (e.g. "En attente d'approbation" stuck at 0 even
    // after a teammate adds a product) until a full page reload. Refetch
    // whenever the tab regains focus/visibility, plus a light poll as a
    // fallback for tabs left open and untouched.
    ...
    const interval = setInterval(refetchProducts, 30000);
      ...
      <div className="flex flex-1 flex-col min-w-0">
        ...
        <main className="flex-1 overflow-y-auto px-8 py-8">
          ...
          >
            ...
            <RecentPosts posts={posts} onChange={refetchProducts} />
          ...
          >
            ...
            <div className="min-w-0">
              ...
              {loading ? (
                ...
                <ProductList products={products} onProductDeleted={refetchProducts} />
              )}
            </div>
          </motion.div>
