            ...
            <div className="w-full max-w-sm">
                ...
                <div className="p-8 bg-white border-3 border-stone-900 rounded-3xl shadow-[6px_6px_0px_0px_rgba(28,25,23,1)]">
                    <div className="mb-6 space-y-1">
                        <h1 className="text-xl font-black text-stone-900 tracking-tight font-serif">Connexion</h1>
                        <p className="text-xs text-stone-400 font-medium">Accédez à l&apos;espace de travail de l&apos;équipe.</p>
                    </div>
                    ...
                    <p className="mt-6 text-center text-xs text-stone-400 font-medium">
                        ...
                        <Link href="/register" className="text-[#F47315] hover:text-[#ff852e] font-extrabold">
                            En créer un
                        </Link>
                    </p>
                </div>
