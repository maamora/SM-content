...
const authCanvasNodes: CanvasNode[] = [
  { id: "auth-prompt", kind: "prompt", label: "SIGNAL", title: "Your next draft", meta: "Ready when you are", detail: "A workspace that keeps the brief, the image, and the decision in the same frame.", x: 21, y: 36, status: "live" },
  { id: "auth-image", kind: "image", label: "SOURCE", title: "Point of view", meta: "Attached context", detail: "Enter a place where creative context does not disappear between tools.", x: 50, y: 23, status: "ready" },
  { id: "auth-output", kind: "image", label: "OUTPUT", title: "Make it move", meta: "A living system", detail: "The next direction is closer than another empty dashboard.", x: 77, y: 39, status: "draft" },
];
