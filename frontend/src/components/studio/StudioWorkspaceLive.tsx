"use client";
/* SIGNAL WORKSTATION / AUTHENTICATED WORKSPACE: a landing-color creative production desk with charcoal tools, warm-paper records, acid-lime active states, and atomic optional Brand-logo persistence. */
