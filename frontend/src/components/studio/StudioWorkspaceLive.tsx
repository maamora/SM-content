"use client";
/* SIGNAL WORKSTATION / AUTHENTICATED WORKSPACE: a landing-color creative production desk with charcoal tools, warm-paper records, and acid-lime active states. Existing APIs, honest fallbacks, and all workflows remain unchanged. */
