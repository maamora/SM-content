...
export default function CreativeStudio({ products, onPostChange }: CreativeStudioProps) {
    ...
    const renderTemplate = async () => {
        ...
        try {
            const result = await generateImage({ productId: selectedProduct.id, templateId, promoText, badgeText, accentColor, mood: moodId, includeBrandLogo: includeBrandLogo && canAddBrandMark });
