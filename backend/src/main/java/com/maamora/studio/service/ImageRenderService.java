...
public class ImageRenderService {
    ...
    public byte[] renderToPng(Template template, Product product,
        ...
        int width = isSquare ? 1024 : 576;
        int height = isSquare ? 1024 : 1024;
    ...
    private byte[] generateImg2Img(Product product, String badgeText, String promoText,
        ...
        String prompt = buildPrompt(product, badgeText, promoText, accentColor, mood);
    ...
    private String buildPrompt(Product product, String badgeText, String promoText,
            String accentColor, String mood) {
        ...
        String promoLine = buildPromoDesc(promoText, badgeText);
        String productName = product.getName();
        String description = nvl(product.getDescription(), "premium Moroccan natural product");
        String sellingPt = nvl(product.getSellingPoint(), "100%% authentic, handcrafted in Morocco");
